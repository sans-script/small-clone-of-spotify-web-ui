...
export default function HomePage() {
  ...
  return (
    <main
      className="w-full h-full rounded-lg ml-2 flex flex-col  overflow-y-hidden"
      style={{
        background:
          "linear-gradient(349deg, rgba(18, 18, 18, 1) 0%, rgba(33, 33, 33, 1) 100%)",
      }}
    ...
    //     <main
    //   className="w-full h-full rounded-lg ml-2 flex flex-col p-2 overflow-y-hidden"
    //   style={{
    //     background:
    //       "linear-gradient(349deg, rgba(18, 18, 18, 1) 0%, rgba(33, 33, 33, 1) 100%)",
    //   }}
    // >
    //   <div className="relative flex w-full h-full overflow-x-auto">
    //     {artists.map((artist, index) => (
    //       <div
    //         key={index}
    //         className="group relative flex rounded-md gap-2 items-end justify-end"
    //       >
    //         <div className="relative w-40 h-40 m-2 mt-0">
    //           <Image
    //             src={artist.imageUrl}
    //             alt={artist.name}
    //             layout="fill"
