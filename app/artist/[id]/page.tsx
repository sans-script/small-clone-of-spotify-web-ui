...
export default function ArtistPage({ params }: ArtistPageProps) {
  ...
  if (!artist) {
    return (
      <main
        className="w-full h-[88%] z-50 rounded-lg ml-2 flex flex-col items-center justify-center"
        style={{
          background:
            "linear-gradient(349deg, rgba(18, 18, 18, 1) 0%, rgba(33, 33, 33, 1) 100%)",
        }}
  ...
  return (
    <main
      className="w-full h-[88%] z-50 rounded-lg ml-2 flex flex-col p-2 overflow-auto"
      style={{
        background:
          "linear-gradient(349deg, rgba(18, 18, 18, 1) 0%, rgba(33, 33, 33, 1) 100%)",
      }}
